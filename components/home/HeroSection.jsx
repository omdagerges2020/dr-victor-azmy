    ...
    <section className="w-full pt-20 md:py-28 bg-background">
      <div className="container mx-auto px-6 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8">
          ...
          >
            <Link href="/booking">{t('bookappointementbtn')}</Link>
            <Icon />
          </Button>
          ...
          >
            <Phone />
            <Link href="/contact">{t('callusbtn')}</Link>
          </Button>
        </div>
      </div>
      {/* Stats */}
      <div className="w-full mt-16 border-t py-10 bg-white">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-sm text-muted-foreground">{t('happypatients')}</p>
          </div>
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-sm text-muted-foreground">{t('treatments')}</p>
          </div>
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-sm text-muted-foreground">{t('emergencycare')}</p>
          </div>
        </div>
      </div>
    </section>
