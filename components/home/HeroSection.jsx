...
export default async function HeroSection() {
  ...
  return (
    <section className="w-full pt-20 md:py-28 bg-[hsl(var(--hero-bg))]">
      <div className="container mx-auto px-6 flex flex-col items-center text-center">
        {/* Badge */}
        <div className="flex items-center gap-2 bg-[hsl(var(--hero-badge-bg))] px-4 py-1.5 rounded-full font-semibold text-md  border border-[hsl(var(--hero-badge-border))] dark:text-[#8B99AD] text-[#6A6E75] mb-6">
          <CheckCircle className="text-green-500" size={16} />
          <span>
            <T k="homepage.badgetitle" />
          </span>
        </div>
        ...
        <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight max-w-4xl text-foreground">
          <T k="homepage.title" />
          <span className="text-[#114398]">
            {" "}
            <T k="homepage.spantitle1" />{" "}
          </span>
          <span className="text-[#1D5AAA]">
            {" "}
            <T k="homepage.spantitle2" />{" "}
          </span>
        </h1>

        {/* Description */}
        <p className="mt-6 text-muted-foreground text-base md:text-lg max-w-2xl">
          <T k="homepage.description" />
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8">
          ...
          >
            <Phone />
            <Link href="/contact">
              <T k="homepage.callusbtn" />
            </Link>
          </Button>
        </div>
      </div>
      {/* Stats */}
      <div className="w-full mt-16 py-10 bg-[hsl(var(--stats-bg))] boder-y border border-[hsl(var(--hero-badge-border))] text-[hsl(var(--stats-text))]">
